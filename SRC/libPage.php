...
function fnOrderConstWork($n1, $n2, $a)
{
	...
	?>
		<a href="javascript:form.act.value='<?php print $a; ?>';form.orderBy.value='<?php print $n2; ?>';form.orderTo.value='desc';form.sPage.value=1;form.submit();">▼</a><!--form.orderTo.valueがascになっていて昇順で検索になっていたため修正-->
<?php
	}
}
